...
export default async function AdminProfilePage() {
  ...
  const [user, comicsAdded, moderated, pending] = await Promise.all([
    userRepository.findById(userId),
    comicService.countComicsByCreator(userId),
    reportService.countResolvedBy(userId),
  ...
  const stats = [
    { label: "Comics Added", count: comicsAdded },
    { label: "Moderated", count: moderated },
